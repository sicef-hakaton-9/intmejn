    ...
    <nav class="bg-secondary border-gray-200 dark:bg-gray-900">
        ...
        >
            <a href="/" class="flex items-center">
                <img
                    src="/images/logo/logo-cityzen-2.png"
                    class="h-12 mr-3"
                    alt="Cityzen Logo"
                />
            </a>
            ...
            >
                <ul
                    class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-secondary md:flex-row md:space-x-8 md:mt-0 md:border-0"
                >
                    <li>
                        <a
                            href="/"
